...
import static com.example.takephoto.MnistModelConfig.CLASSIFICATION_THRESHOLD;
import static com.example.takephoto.MnistModelConfig.MAX_CLASSIFICATION_RESULTS;
public class MnistClassifier {
    ...
    public List<Classification> recognizeImage(Bitmap preprocessedImage) {
